...
%a mistake was made when soldering to sensor molex connectors in reverse this should be corrected for future boards and sensor molex pins, it didnt cause any porblems with the delivery mechanism but could cause confusion for someone assembling it without prior knowledge of this mistake.

%redesign dip20 dispenser to compensate for height of components.

%dip holder sensor should be placed flat as low as possible
