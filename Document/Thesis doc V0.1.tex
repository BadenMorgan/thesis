...
\section{Introduction}
	...
	For convenience to the reader, if this document is being read on a computer or digital device that support the pdf format, take note of underlined citations which are in light green, cross-referencing within the document which are in red and links in the referencing which are in light blue. This underlining indicates a clickable link which will direct you to the referenced item.
	\newpage
\setlength{\parskip}{1em}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	% literature review
