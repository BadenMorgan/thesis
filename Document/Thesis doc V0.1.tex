...
Test were done with the RS 485 bus transceiver chip and the communications worked as expected. However there were problems with communication but it was found that limitations of the Raspberry Pi and its ability to interact with the RS 485 bus transceiver. This was found during debugging of the final assembly. It was isolated to the Raspberry pi by testing communications with the MCU modules alone and they were able to communicate with each other flawlessly. 
